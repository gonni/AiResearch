...
public class SingleStockDataSetIterator implements DataSetIterator {
    ...
    public SingleStockDataSetIterator (String filename, String symbol, int miniBatchSize, int exampleLength,
